...
<div class="container">
    <section id="content">
        <form id="msform"  method="post" action="<%=request.getContextPath()%>/main/admin/addAdmin">
            ...
            <input type="text" id="hierarchy" name="hierarchy" placeholder="Designation i.e Secretary, Finance Officer" />
